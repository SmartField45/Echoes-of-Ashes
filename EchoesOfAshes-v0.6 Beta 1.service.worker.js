...
/** @type {string} */
const CACHE_VERSION = '1781919134|60185456';
/** @type {string} */
const CACHE_PREFIX = 'Echoes Of Ashes-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'EchoesOfAshes-v0.6 Beta 1.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["EchoesOfAshes-v0.6 Beta 1.html","EchoesOfAshes-v0.6 Beta 1.js","EchoesOfAshes-v0.6 Beta 1.offline.html","EchoesOfAshes-v0.6 Beta 1.icon.png","EchoesOfAshes-v0.6 Beta 1.apple-touch-icon.png","EchoesOfAshes-v0.6 Beta 1.audio.worklet.js","EchoesOfAshes-v0.6 Beta 1.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["EchoesOfAshes-v0.6 Beta 1.wasm","EchoesOfAshes-v0.6 Beta 1.pck"];
